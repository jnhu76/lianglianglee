...
<head>
    ...
    <head>
        ...
        <meta name='description' content=67&#32;如何写一个必然死锁的例子？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="67 如何写一个必然死锁的例子？" class="title">67 如何写一个必然死锁的例子？</h1>
...
<p>如果 flag 等于 1，就会先获取 o1 这把锁，然后休眠 500 毫秒，再去尝试获取 o2 这把锁并且打印出&rdquo;线程1获得了两把锁&rdquo;。</p>

<p>如果 flag 等于 2，那么情况恰恰相反，线程会先获取 o2 这把锁，然后休眠 500 毫秒，再去获取 o1 这把锁，并且打印出&rdquo;线程2获得了两把锁&rdquo;。</p>
