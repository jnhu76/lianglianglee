...
<head>
    ...
    <head>
        ...
        <meta name='description' content=31&#32;为什么&#32;Map&#32;桶中超过&#32;8&#32;个才转为红黑树？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="31 为什么 Map 桶中超过 8 个才转为红黑树？" class="title">31 为什么 Map 桶中超过 8 个才转为红黑树？</h1>
...
<p>在这个例子中，我们建了一个 HashMap，并且不停地往里放入值，所放入的 key 的对象，它的 hashCode 是被重写过得，并且始终返回 1。这段代码运行时，如果通过 debug 让程序暂停在 System.out.println(&ldquo;运行结束&rdquo;) 这行语句，我们观察 map 内的节点，可以发现已经变成了 TreeNode，而不是通常的 Node，这说明内部已经转为了红黑树。</p>
