...
<head>
    ...
    <head>
        ...
        <meta name='description' content=32&#32;如何评估代码的安全缺陷？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="32 如何评估代码的安全缺陷？" class="title">32 如何评估代码的安全缺陷？</h1>
...
<p><img src="assets/355170caae4a69136f6c4974c03359b4.png" alt="" />-
上述外卖系统的软件缺陷的优先级应该是中等优先级（P2，高严重性、低可能性）。</p>
...
<p><img src="assets/80fd5d616f4d315565d9a0156bf33324.png" alt="" />-
...
<p><img src="assets/e9476045a739a8b96f67fdb163d60cbd.png" alt="" />-
我们曾经谈到过&rdquo;<a href="https://time.geekbang.org/column/article/77048" target="_blank">goto fail</a>&ldquo;这个安全问题，如果使用通用缺陷评分系统，计分是7.2，<a href="https://www.first.org/cvss/calculator/3.0#CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:C/C:L/I:L/A:N" target="_blank">直观描述</a>如下图所示：</p>

<p><img src="assets/c6a735042e72364a2ad1689c79869690.png" alt="" />-
