...
<head>
    ...
    <head>
        ...
        <meta name='description' content=06&#32;窗口和标签页：修改、对比多个文件的正确姿势>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="06 窗口和标签页：修改、对比多个文件的正确姿势" class="title">06 窗口和标签页：修改、对比多个文件的正确姿势</h1>
                            <div><p>你好，我是吴咏炜。</p>
...
<p><img src="assets/e0ea398be76e787d9f06b22d62756bdb.gif" alt="Fig6.1" title="窗口分割演示" /></p>
...
<p><img src="assets/fc9a2b82ece7eaeeb940806bfcae9b08.png" alt="Fig6.2" title="比较两个 C++ 文件" /></p>
...
<p><img src="assets/7a8a884f991d412fc2dyy41ef5ab7971.png" alt="Fig6.3" title="终端里运行的有两个标签页的 Vim" /></p>
...
<p><img src="assets/776ac4fc034b3556f4639c42c1ed1b1f.png" alt="Fig6.4" title="NERDTree 的使用界面" /></p>
...
<p><img src="assets/f8f1e7a095594a52c170677cd3357944.png" alt="Fig6.5" title="VimExplorer 的界面和右键菜单" /></p>
