...
<head>
    ...
    <head>
        ...
        <meta name='description' content=13&#32;&#32;缓存原理：应对面试你要掌握&#32;Redis&#32;哪些原理？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="13  缓存原理：应对面试你要掌握 Redis 哪些原理？" class="title">13  缓存原理：应对面试你要掌握 Redis 哪些原理？</h1>
...
<ul>
<li><strong>平均分配：</strong> 在使用 cluster create 命令创建 Redis 集群时，Redis 会自动把所有哈希槽平均分布到集群实例上。比如集群中有 9 个实例，则每个实例上槽的个数为 <sup>16384</sup>&frasl;<sub>9</sub> 个。</li>
