...
<head>
    ...
    <head>
        ...
        <meta name='description' content=17&#32;&#32;链路追踪：Zipkin&#32;如何进行分布式追踪？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="17  链路追踪：Zipkin 如何进行分布式追踪？" class="title">17  链路追踪：Zipkin 如何进行分布式追踪？</h1>
...
<p>请求头中除了基础的 Header 信息以外，还会有很多以 &ldquo;X-B3&rdquo; 开头的内容，比如TraceId、SpanId 等关键信息，就是经由 Zipkin 产生的链路上下文信息。</p>
