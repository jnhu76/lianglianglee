...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="35 快速构建持续交付系统（二）：GitLab 解决代码管理问题" class="title">35 快速构建持续交付系统（二）：GitLab 解决代码管理问题</h1>
...
sudo firewall-cmd &ndash;permanent &ndash;add-service=http
...
<p>sudo EXTERNAL_URL=&rdquo;<a href="http://192.168.0.101&quot;" target="_blank">http://192.168.0.101&rdquo;</a> yum install -y gitlab-ee</p></li>
</ol>
...
<p>external_url &lsquo;<a href="http://newhost.com'" target="_blank">http://newhost.com&rsquo;</a></p></li>
</ol>
