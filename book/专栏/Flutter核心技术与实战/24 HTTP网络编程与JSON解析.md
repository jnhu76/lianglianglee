...
<head>
    ...
    <head>
        ...
        <meta name='description' content=24&#32;HTTP网络编程与JSON解析>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="24 HTTP网络编程与JSON解析" class="title">24 HTTP网络编程与JSON解析</h1>
                            <div><p>你好，我是陈航。</p>
...
<ol>
<li>请使用dio实现一个自定义拦截器，拦截器内检查header中的token：如果没有token，需要暂停本次请求，同时访问&rdquo;<a href="http://xxxx.com/token" target="_blank">http://xxxx.com/token</a>&ldquo;，在获取新token后继续本次请求。</li>
