...
<head>
    ...
    <head>
        ...
        <meta name='description' content=21&#32;路由与导航，Flutter是这样实现页面切换的>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="21 路由与导航，Flutter是这样实现页面切换的" class="title">21 路由与导航，Flutter是这样实现页面切换的</h1>
                            <div><p>你好，我是陈航。</p>
...
<p><img src="assets/5095923739164df8adb0ce7feabf05f7.jpg" alt="" /></p>
...
<p>路由表实际上是一个Map<String,WidgetBuilder>，其中key值对应页面名字，而value值则是一个WidgetBuilder回调函数，我们需要在这个函数中创建对应的页面。而一旦在路由表中定义好了页面名字，我们就可以使用Navigator.pushNamed来打开页面了。</p>
...
<p><img src="assets/7b714dd0f03e4664824e88c6174616cf.jpg" alt="" /></p>
...
<p><img src="assets/eb0fac7afbaa4d81a83d4c9e047a4c49.jpg" alt="" /></p>
