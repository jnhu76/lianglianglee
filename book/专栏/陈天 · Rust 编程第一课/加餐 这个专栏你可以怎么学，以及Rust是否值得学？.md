...
<head>
    ...
    <head>
        ...
        <meta name='description' content=加餐&#32;这个专栏你可以怎么学，以及Rust是否值得学？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="加餐 这个专栏你可以怎么学，以及Rust是否值得学？" class="title">加餐 这个专栏你可以怎么学，以及Rust是否值得学？</h1>
                            <div><p>你好，我是陈天。</p>
...
<p><img src="assets/b3888e6082a613d3da04658089dc361e.jpg" alt="图片" /></p>
...
<p><img src="assets/5e5d6f5f07d6b89ab1c6e460da628fa7.jpg" alt="" />这个问题发生在支持多线程的语言中，比如说两个线程间访问同一个变量，如果没有做合适的临界区保护，就很容易发生并发安全问题。</p>
...
<p>很多语言并没有强制开发者一定要处理错误，Rust 使用 Result<T, E> 类型来保证错误的类型安全，还强制你必须处理这个类型返回的值，避免开发者丢弃错误。</p>
...
<p>再往下的三类缺陷是语言和编译器无法帮助解决的。<img src="assets/4fddb2183740d6d563520ecbb72a7924.jpg" alt="" /></p>
...
<p><img src="assets/b0f7fea4cddac6d0630ffde12beaf606.jpg" alt="图片" /></p>
...
<p><img src="assets/d9bbabdc138a3abb48f6f8b67c4e6d7b.png" alt="图片" /></p>
...
<p><img src="assets/b28e0c8802e4c5e59dc219b7aa581fac.png" alt="图片" /></p>
