...
<head>
    ...
    <head>
        ...
        <meta name='description' content=28&#32;网络开发（上）：如何使用Rust处理网络请求？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="28 网络开发（上）：如何使用Rust处理网络请求？" class="title">28 网络开发（上）：如何使用Rust处理网络请求？</h1>
...
<img src="assets/909ec0f611352fyy5b99f27bb2f557ef.jpg" alt="" /></p>
...
<img src="assets/8ff212b28a88d697303a5fcd35174d78.jpg" alt="" /></p>
...
<p>在这个例子中，客户端在连接成功后，会发送 12 个字节的 &ldquo;hello world!&ldquo;给服务器，服务器读取并回复后，客户端会尝试接收完整的、来自服务器的 17个字节的 “glad to meet you!”。</p>
...
<img src="assets/1f6c58c3944ec6f0f5a01a3235740693.jpg" alt="" /></p>
...
<img src="assets/9dae3be8e76512611d54eb8875fb962d.jpg" alt="" /></p>
...
<img src="assets/fb40a748abfdbb731ea2f15a4aea590d.jpg" alt="" /></p>
...
<img src="assets/b4171bafa947d925c11087c83yyb7b44.jpg" alt="" /></p>
...
<p>消息尾添加 “\r\n” 一般用于基于文本的协议，比如 HTTP 头/POP3/Redis 的 RESP 协议等。但对于<strong>二进制协议，更好的方式是在消息前面添加固定的长度</strong>，比如对于 protobuf 这样的二进制而言，消息中的数据可能正好出现连续的&rdquo;\r\n&rdquo;，如果使用 “\r\n” 作为消息的边界，就会发生紊乱，所以不可取。</p>
...
<img src="assets/9186d8aef9aea6fb760d0c2537d3e6ed.png" alt="" /></p>
