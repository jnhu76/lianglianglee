...
<head>
    ...
    <head>
        ...
        <meta name='description' content=31&#32;sync.WaitGroup和sync.Once>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="31 sync.WaitGroup和sync.Once" class="title">31 sync.WaitGroup和sync.Once</h1>
...
<p><img src="assets/fac7dfa184053d2a95e121aa17141d8d.png" alt="" />-
（sync.WaitGroup的计数周期）</p>
