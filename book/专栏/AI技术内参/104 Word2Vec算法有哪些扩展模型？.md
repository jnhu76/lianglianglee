...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="104 Word2Vec算法有哪些扩展模型？" class="title">104 Word2Vec算法有哪些扩展模型？</h1>
...
<li><p>Jian Tang, Meng Qu, Mingzhe Wang, Ming Zhang, Jun Yan, and Qiaozhu Mei. <a href="http://www.www2015.it/documents/proceedings/proceedings/p1067.pdf" target="_blank">LINE: Large-scale Information Network Embedding</a>. Proceedings of the 24th International Conference on World Wide Web (WWW &lsquo;15). International World Wide Web Conferences Steering Committee, Republic and Canton of Geneva, Switzerland, 1067-1077, 2015.</p></li>

<li><p>Mihajlo Grbovic, Nemanja Djuric, Vladan Radosavljevic, Fabrizio Silvestri, and Narayan Bhamidipati. <a href="https://astro.temple.edu/~tua95067/grbovic2015sigirconf.pdf" target="_blank">Context- and Content-aware Embeddings for Query Rewriting in Sponsored Search</a>. Proceedings of the 38th International ACM SIGIR Conference on Research and Development in Information Retrieval (SIGIR &lsquo;15). ACM, New York, NY, USA, 383-392, 2015.</p></li>
</ol>
</div>
                        </div>
                        <div>
