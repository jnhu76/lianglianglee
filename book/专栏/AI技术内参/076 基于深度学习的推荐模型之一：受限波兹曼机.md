...
<head>
    ...
    <head>
        ...
        <meta name='description' content=076&#32;基于深度学习的推荐模型之一：受限波兹曼机>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="076 基于深度学习的推荐模型之一：受限波兹曼机" class="title">076 基于深度学习的推荐模型之一：受限波兹曼机</h1>
...
<ol>
<li>Ruslan Salakhutdinov, Andriy Mnih, and Geoffrey Hinton. <em>Restricted Boltzmann machines for collaborative filtering</em>. Proceedings of the 24th international conference on Machine learning (ICML &lsquo;07), Zoubin Ghahramani (Ed.). ACM, New York, NY, USA, 791-798, 2007.</li>
</ol>
</div>
                        </div>
                        <div>
