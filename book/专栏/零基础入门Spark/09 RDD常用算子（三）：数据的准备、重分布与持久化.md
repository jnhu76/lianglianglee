...
<head>
    ...
    <head>
        ...
        <meta name='description' content=09&#32;RDD常用算子（三）：数据的准备、重分布与持久化>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="09 RDD常用算子（三）：数据的准备、重分布与持久化" class="title">09 RDD常用算子（三）：数据的准备、重分布与持久化</h1>
                            <div><p>你好，我是吴磊。</p>
...
<p><img src="assets/4ebaf6b9762b2d7ba64d21d8664080d3.jpg" alt="图片" title="RDD算子分类表" /></p>

<p>你可能会觉得，这些高亮显示的算子乍一看也没什么关联啊？但如果我们从数据生命周期的角度入手，给它们归归类，很容易就会发现这些算子分别隶属于生命周期的某个阶段。</p>

<p><img src="assets/8fc62a1795606466f1fe391d098731cb.jpg" alt="图片" title="数据生命周期" /></p>
...
<p><img src="assets/36bc7990bcbc9e17b2af1193f9db022d.png" alt="图片" title="coalesce与repartition有着不同的执行计划" /></p>
...
<p><img src="assets/e776b77d36725728f44905d4dfe7f390.jpg" alt="图片" title="repartition与coalesce计算原理示意图" /></p>
...
<p><img src="assets/61684b05fbefcc777e995f644c9cfe65.jpg" alt="图片" title="collect算子工作原理" /></p>
...
<p><img src="assets/2892b89238d64006be177fd7fde531e0.jpg" alt="图片" title="saveAsTextFile工作原理" /></p>
...
<p><img src="assets/71742561e52b2b3edeedee5d3d6913bc.jpg" alt="图片" title="RDD常用算子一览" /></p>
