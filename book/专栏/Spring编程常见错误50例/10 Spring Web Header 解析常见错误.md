...
<head>
    ...
    <head>
        ...
        <meta name='description' content=10&#32;Spring&#32;Web&#32;Header&#32;解析常见错误>
...
<p><img src="assets/0cbf5aa76e434cac8a00a95cfc52fe17.jpg" alt="" /></p>
...
<blockquote>
<p>[myheader:&ldquo;h1&rdquo;, &ldquo;h2&rdquo;, host:&ldquo;localhost:8080&rdquo;, connection:&ldquo;Keep-Alive&rdquo;, user-agent:&ldquo;Apache-HttpClient/4.5.12 (Java/11.0.6)&rdquo;, accept-encoding:&ldquo;gzip,deflate&rdquo;]</p>
</blockquote>
...
<p>我们知道，对于&rdquo;@RequestHeader(&ldquo;MyHeader&rdquo;) String myHeader&rdquo;的定义，Spring 使用的是 RequestHeaderMethodArgumentResolver 来做解析。解析的方法参考 RequestHeaderMethodArgumentResolver#resolveName：</p>
...
<p>从上述方法的关键调用&rdquo;request.getHeaderValues(name)&ldquo;去按图索骥，我们可以找到查找 Header 的最根本方法，即 org.apache.tomcat.util.http.ValuesEnumerator#findNext：</p>
...
<p>可以看到 myHeader 设置成功了，但是 Content-Type 并没有设置成我们想要的&rdquo;application/json&rdquo;，而是&rdquo;text/plain;charset=UTF-8&rdquo;。为什么会出现这种错误？</p>
...
<p><img src="assets/e24f8fde8cdd4dd08be4fc3f337c74d2.jpg" alt="" /></p>
...
<p><img src="assets/4730528ead9b4c92a29dfa3ef10bb648.jpg" alt="" /></p>
...
<p>结合案例，参考代码，我们可以看出，我们使用的是 MediaType#TEXT_PLAIN 作为 Content-Type 的 Header，毕竟之前我们添加 Content-Type 这个 Header 并没有成功。最终运行结果也就不出意外了，即&rdquo;Content-Type: text/plain;charset=UTF-8&rdquo;。</p>
...
<script data-cfasync="false" src="/static/email-decode.min.js"></script><script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8f128a424dcdede4',t:'MTczNDA1NzEwOS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/static/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
