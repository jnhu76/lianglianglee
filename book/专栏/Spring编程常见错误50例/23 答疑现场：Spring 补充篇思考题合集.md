...
<head>
    ...
    <head>
        ...
        <meta name='description' content=23&#32;答疑现场：Spring&#32;补充篇思考题合集>
...
<p><img src="assets/2f0d2b7f22254ef7b191ece3c6545084.jpg" alt="" /></p>
...
<p><img src="assets/8148a15e5a3d4342b364fffd1b9e5e45.jpg" alt="" /></p>
...
<p>在这个完成过程中，它会使用 ConfigurationClassParser.DeferredImportSelectorHandler 来完成对 Import 的处理。AutoConfigurationImportSelector 就是其中一种Import，它被 @EnableAutoConfiguration 这个注解间接引用。它会加载&rdquo;META-INF/spring.factories&rdquo;中定义的 RedisAutoConfiguration，此时我们就会发现 StringRedisTemplate 和 RedisTemplate 这两个 Bean 了。</p>
...
<blockquote>
<p>In Spring MVC, &ldquo;request parameters&rdquo; map to query parameters, form data, and parts in multipart requests. This is because the Servlet API combines query parameters and form data into a single map called &ldquo;parameters&rdquo;, and that includes automatic parsing of the request body.</p>
</blockquote>
...
<p><img src="assets/8713edfa6bf14ee9989d05de1383716f.jpg" alt="" /></p>
