...
<head>
    ...
    <head>
        ...
        <meta name='description' content=15&#32;自动化注入神器（二）：sqlmap的设计架构解析>
...
<p>这个值是用“2_M/T”这个表达式计算出来的，要想得出结果，我们需要获得变量M和T的值。其中M为a和b相同部分的长度，在这个例子中，因为<code>a</code>和<code>b</code>相同部分为<code>ab</code>，所以M的 值就是2。T则是a和b的长度之和，所以T的值为9。因此，计算结果为“2_<sup>2</sup>&frasl;<sub>9</sub>=0.4444…”。</p>
