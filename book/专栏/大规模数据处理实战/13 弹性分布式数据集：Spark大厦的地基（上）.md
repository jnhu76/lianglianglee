...
<head>
    ...
    <head>
        ...
        <meta name='description' content=13&#32;弹性分布式数据集：Spark大厦的地基（上）>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="13 弹性分布式数据集：Spark大厦的地基（上）" class="title">13 弹性分布式数据集：Spark大厦的地基（上）</h1>
                            <div><p>你好，我是蔡元楠。</p>
...
<p><img src="assets/6f280b3aa2a845abb08f39f05d493c80.jpg" alt="" /></p>
...
<p><img src="assets/eb362a35b7d84279b90a02b6cd157866.jpg" alt="" /></p>
...
<p><img src="assets/65a40ed927634b959b7e52182ed80e0f.jpg" alt="" /></p>

<p>窄依赖就是父RDD的分区可以一一对应到子RDD的分区，宽依赖就是父RDD的每个分区可以被多个子RDD的分区使用。</p>

<p><img src="assets/541a2c47d5054d6295a1583a92c0dde5.jpg" alt="" /></p>
