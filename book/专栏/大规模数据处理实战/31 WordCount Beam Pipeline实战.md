...
<head>
    ...
    <head>
        ...
        <meta name='description' content=31&#32;WordCount&#32;Beam&#32;Pipeline实战>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="31 WordCount Beam Pipeline实战" class="title">31 WordCount Beam Pipeline实战</h1>
                            <div><p>你好，我是蔡元楠。</p>
...
<p><img src="assets/6545ac7274d2498298b0986bc67cea9c.jpg" alt="" /></p>
...
<p>我们这里试着把上面的ExtractWordsFn和Count两个Transform封装起来。这样可以对这样一整套数据处理操作复用和测试。当定义PTransform的子类时，它的输入输出类型就是一连串Transform的最初输入和最终输出。那么在这里，输入类型是String，输出类型是KV<String, Long>。就如同下面的代码一样。</p>
...
<p>什么意思呢？比如，ExtractWordsFn我们想要测试它能把一个句子分拆出单词，比如“&rdquo; some input words &ldquo;，我们期待的输出是[“some”, “input”, “words”]。在测试中，我们可以这样表达：</p>
...
<p>文中提供了分词的DoFn——ExtractWordsFn，你能利用相似的思路把输出文本的格式化写成一个DoFn吗？也就是文中的FormatAsTextFn，把PCollection<KV<String, Long>&gt; 转化成PCollection ，每一个元素都是 : 的格式。</p>
