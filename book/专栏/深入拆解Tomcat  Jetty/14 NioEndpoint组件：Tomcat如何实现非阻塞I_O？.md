...
<head>
    ...
    <head>
        ...
        <meta name='description' content=14&#32;NioEndpoint组件：Tomcat如何实现非阻塞I_O？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="14 NioEndpoint组件：Tomcat如何实现非阻塞I_O？" class="title">14 NioEndpoint组件：Tomcat如何实现非阻塞I_O？</h1>
...
<p><img src="assets/6f78100a01444254a87d6f1902d61df1.jpg" alt="" /></p>
...
<p><img src="assets/308c3c2683634218bded0fc72d776d79.jpg" alt="" /></p>
...
<p><img src="assets/b201f6dec2ce48d28a9b6283b1994166.jpg" alt="" /></p>

<p><strong>异步I/O</strong>：用户线程发起read调用的同时注册一个回调函数，read立即返回，等内核将数据准备好后，再调用指定的回调函数完成处理。在这个过程中，用户线程一直没有阻塞。</p>

<p><img src="assets/dd8f92e084e6417ea2e5d9da4285525e.jpg" alt="" /></p>
...
<p><img src="assets/12d2bb6a414d4b85b94a4272d3ba4d69.jpg" alt="" /></p>
