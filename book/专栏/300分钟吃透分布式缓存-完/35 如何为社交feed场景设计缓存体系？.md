...
<head>
    ...
    <head>
        ...
        <meta name='description' content=35&#32;如何为社交feed场景设计缓存体系？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="35 如何为社交feed场景设计缓存体系？" class="title">35 如何为社交feed场景设计缓存体系？</h1>
...
<p>Feed 流的缓存体系中，对于 Memcached 存储采用 L1-Main-Backup 架构。这个架构前面在讲分布式 Memcached 实践中也有介绍。微博 Feed 流的 Memcached 存储架构体系中，L1 单池容量一般为 Main 池的 1/10，有 4~6 组 L1，用于存放最热的数据，可以很好的解决热点事件或节假日的流量洪峰问题。Main 池容量最大，保存了最近一段时间的几乎所有较热的数据。Backup  池的容量一般在 Main 池的 <sup>1</sup>&frasl;<sub>2</sub> 以下，主要解决 Main 池异常发生或者 miss 后的 key 访问。</p>
