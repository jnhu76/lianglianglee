...
<head>
    ...
    <head>
        ...
        <meta name='description' content=04&#32;&#32;Dubbo&#32;SPI&#32;精析，接口实现两极反转（下）>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="04  Dubbo SPI 精析，接口实现两极反转（下）" class="title">04  Dubbo SPI 精析，接口实现两极反转（下）</h1>
...
<p>在 Provider 端调用 getActivateExtension() 方法时传入的 values 配置为 &ldquo;demoFilter3、-demoFilter2、default、demoFilter1&rdquo;，那么根据上面的逻辑：</p>
