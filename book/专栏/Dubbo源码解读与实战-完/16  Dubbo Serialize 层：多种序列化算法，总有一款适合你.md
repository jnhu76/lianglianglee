...
<head>
    ...
    <head>
        ...
        <meta name='description' content=16&#32;&#32;Dubbo&#32;Serialize&#32;层：多种序列化算法，总有一款适合你>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="16  Dubbo Serialize 层：多种序列化算法，总有一款适合你" class="title">16  Dubbo Serialize 层：多种序列化算法，总有一款适合你</h1>
...
<p><strong>Fst（全称是 fast-serialization）是一款高性能 Java 对象序列化工具包</strong>，100% 兼容 JDK 原生环境，序列化速度大概是JDK 原生序列化的 4~10 倍，序列化后的数据大小是 JDK 原生序列化大小的 <sup>1</sup>&frasl;<sub>3</sub> 左右。目前，Fst 已经更新到 3.x 版本，支持 JDK 14。</p>
