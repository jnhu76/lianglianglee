...
<head>
    ...
    <head>
        ...
        <meta name='description' content=21&#32;分布式锁：为什么基于etcd实现分布式锁比Redis锁更安全？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="21 分布式锁：为什么基于etcd实现分布式锁比Redis锁更安全？" class="title">21 分布式锁：为什么基于etcd实现分布式锁比Redis锁更安全？</h1>
                            <div><p>你好，我是唐聪。</p>
...
<p><img src="assets/9aa7910742334a1696efe78aeac7f130.jpg" alt="" /></p>
...
<p><img src="assets/9b60f16fcc354d8b82330269050c1922.jpg" alt="" /></p>
...
<p>正如在<a href="https://time.geekbang.org/column/article/339337" target="_blank">06</a>租约特性中和你介绍的，Lease就是一种活性检测机制，它提供了检测各个客户端存活的能力。你的业务client需定期向etcd服务发送&rdquo;特殊心跳&rdquo;汇报健康状态，若你未正常发送心跳，并超过和etcd服务约定的最大存活时间后，就会被etcd服务移除此Lease和其关联的数据。</p>
