...
<head>
    ...
    <head>
        ...
        <meta name='description' content=30&#32;GroupMetadataManager：位移主题保存的只是位移吗？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="30 GroupMetadataManager：位移主题保存的只是位移吗？" class="title">30 GroupMetadataManager：位移主题保存的只是位移吗？</h1>
...
<p><img src="assets/032bdb247859f796a5ca21c3db710007.jpg" alt="" /></p>
...
<p>第2步，代码依次向结构体写入消费者组的协议类型（Protocol Type）、Generation ID、分区分配策略（Protocol Name）和Leader成员ID。在学习GroupMetadata时，我说过，对于普通的消费者组而言，协议类型就是&rdquo;consumer&rdquo;字符串，分区分配策略可能是&rdquo;range&rdquo;&ldquo;round-robin&rdquo;等。之后，代码还会为格式版本≥2的结构体，写入消费者组状态最近一次变更的时间戳。</p>
...
<p><img src="assets/4d5ecbdc21d5bb29d054443e31eab28f.jpg" alt="" /></p>
...
<p><img src="assets/90f52b9fbf2b8daced15717aafdd24bd.jpg" alt="" /></p>
...
<p><img src="assets/03843d5742157064dbb8bd227b9fb7e8.jpg" alt="" /></p>
