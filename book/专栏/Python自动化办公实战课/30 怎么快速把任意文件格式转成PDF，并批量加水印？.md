...
<head>
    ...
    <head>
        ...
        <meta name='description' content=30&#32;怎么快速把任意文件格式转成PDF，并批量加水印？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="30 怎么快速把任意文件格式转成PDF，并批量加水印？" class="title">30 怎么快速把任意文件格式转成PDF，并批量加水印？</h1>
                            <div><p>你好，我是尹会生。</p>
...
<p>为了让你更好地理解win32com库的执行过程，我来为你举个例子。我在&rdquo;C:\data&rdquo;文件夹下有一个Word格式的a.doc文件，现在要将它自动转换为a.pdf文件，并继续存储在该目录中。如果你手动进行格式转换，只是需要以下四个步骤：</p>
...
<p><img src="assets/46e8a494423b40b2a6e879533089b8bc.jpg" alt="" /></p>
