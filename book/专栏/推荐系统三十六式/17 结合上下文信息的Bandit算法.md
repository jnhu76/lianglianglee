...
<head>
    ...
    <head>
        ...
        <meta name='description' content=17&#32;结合上下文信息的Bandit算法>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="17 结合上下文信息的Bandit算法" class="title">17 结合上下文信息的Bandit算法</h1>
...
<p><img src="assets/eae9254fef3cdfc681247f58fa740b4b.png" alt="" /></p>

<p>两个用户就是Bandit算法要面对的上下文，表示成特征就是下面的样子。</p>

<p><img src="assets/d47f7f976d7a0fd651f8f4be67f8aeae.png" alt="" /></p>
