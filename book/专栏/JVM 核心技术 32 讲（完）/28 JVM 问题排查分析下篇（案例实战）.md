...
<head>
    ...
    <head>
        ...
        <meta name='description' content=28&#32;JVM&#32;问题排查分析下篇（案例实战）>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="28 JVM 问题排查分析下篇（案例实战）" class="title">28 JVM 问题排查分析下篇（案例实战）</h1>
...
<p>再分析上面这个图，可以看到老年代对应的内存池是 &ldquo;ps_old_gen&rdquo;，通过前面的学习，我们知道，ps 代表的是 ParallelGC 垃圾收集器。</p>
