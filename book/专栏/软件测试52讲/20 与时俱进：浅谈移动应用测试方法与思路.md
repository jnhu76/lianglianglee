...
<head>
    ...
    <head>
        ...
        <meta name='description' content=20&#32;与时俱进：浅谈移动应用测试方法与思路>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="20 与时俱进：浅谈移动应用测试方法与思路" class="title">20 与时俱进：浅谈移动应用测试方法与思路</h1>
...
<p><img src="assets/59e6df9d206104e69d94736997509a31.png" alt="" /></p>
...
<p><img src="assets/1c3526428800a068d56dc8e194645867.png" alt="" /></p>
...
<p><img src="assets/cf8b774a44899110d2ba2dfbaa9a4db3.png" alt="" /></p>
...
<p>唯一需要注意的是，Native Container和Webview分别属于两个不同的上下文（Context），Native Container默认的Context为“NATIVE APP&rdquo;，而Webview默认的Context为“WEBVIEW_+被测进程名称”。</p>

<p>所以，当需要操作Webview中的网页元素时，需要先切换到Webview的Context下，如图4所示代码就完成了这一切换操作。</p>

<p><img src="assets/35549fade212214212730ab91de83518.png" alt="" /></p>
