...
<head>
    ...
    <head>
        ...
        <meta name='description' content=38&#32;测试数据的“银弹”-&#32;统一测试数据平台（下）>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="38 测试数据的“银弹”- 统一测试数据平台（下）" class="title">38 测试数据的“银弹”- 统一测试数据平台（下）</h1>
...
<p><img src="assets/51f2943559843cb2a7b521723fd7a325.png" alt="" /></p>

<p>图1 最初的统一测试数据平台UI界面</p>

<p>后来，随着统一测试数据平台的广泛使用，我们逐渐加入了更多的创新设计，统一测试数据平台的架构也逐渐演变成了如图2所示的样子。</p>

<p><img src="assets/7d4cdac895834f96e777234a0f6db40d.png" alt="" /></p>
