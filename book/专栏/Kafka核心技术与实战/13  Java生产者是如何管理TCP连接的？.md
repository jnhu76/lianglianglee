...
<head>
    ...
    <head>
        ...
        <meta name='description' content=13&#32;&#32;Java生产者是如何管理TCP连接的？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="13  Java生产者是如何管理TCP连接的？" class="title">13  Java生产者是如何管理TCP连接的？</h1>
...
<p>你不需要了解RecordAccumulator类是做什么的，你只要知道它主要的数据结构是一个ConcurrentMap<TopicPartition, Deque>。TopicPartition是Kafka用来表示主题分区的Java对象，本身是不可变对象。而RecordAccumulator代码中用到Deque的地方都有锁的保护，所以基本上可以认定RecordAccumulator类是线程安全的。</p>
...
<p><img src="assets/de71cc4b496a22e47b4ce079dbe99238.jpg" alt="" /></p>
