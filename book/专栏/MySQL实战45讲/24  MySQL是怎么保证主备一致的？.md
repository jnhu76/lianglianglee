...
<head>
    ...
    <head>
        ...
        <meta name='description' content=24&#32;&#32;MySQL是怎么保证主备一致的？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="24  MySQL是怎么保证主备一致的？" class="title">24  MySQL是怎么保证主备一致的？</h1>
...
use &lsquo;test’命令之后的 delete 语句，就是我们输入的 SQL 原文了。可以看到，binlog“忠实”地记录了 SQL 命令，甚至连注释也一并记录了。</li>
