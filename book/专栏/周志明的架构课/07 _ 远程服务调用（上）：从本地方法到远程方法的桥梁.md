...
<head>
    ...
    <head>
        ...
        <meta name='description' content=07&#32;_&#32;远程服务调用（上）：从本地方法到远程方法的桥梁>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="07 _ 远程服务调用（上）：从本地方法到远程方法的桥梁" class="title">07 _ 远程服务调用（上）：从本地方法到远程方法的桥梁</h1>
...
<li>拓扑结构是一成不变的（Topology doesn&rsquo;t change）</li>
...
<p><img src="assets/4eb9e67dd8854140a7a28d4371f80227.jpg" alt="" /></p>
