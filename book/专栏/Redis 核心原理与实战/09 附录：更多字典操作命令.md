...
<head>
    ...
    <head>
        ...
        <meta name='description' content=09&#32;附录：更多字典操作命令>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="09 附录：更多字典操作命令" class="title">09 附录：更多字典操作命令</h1>
                            <div><h3 id="插入一个或多个元素">插入一个或多个元素</h3>

<p>语法：hmset key field value [field value &hellip;] 示例：</p>
...
<p>语法：hmget key field [field &hellip;] 示例：</p>
