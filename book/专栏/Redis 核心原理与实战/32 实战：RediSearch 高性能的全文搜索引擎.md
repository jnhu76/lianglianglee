...
<head>
    ...
    <head>
        ...
        <meta name='description' content=32&#32;实战：RediSearch&#32;高性能的全文搜索引擎>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="32 实战：RediSearch 高性能的全文搜索引擎" class="title">32 实战：RediSearch 高性能的全文搜索引擎</h1>
...
<p>注意：<strong>这里必须要设置语言编码为中文，也就是“language &ldquo;chinese&rdquo;”</strong>，默认是英文编码，如果不设置则无法支持中文查询（无法查出结果）。</p>
