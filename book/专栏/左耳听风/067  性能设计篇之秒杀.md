...
<head>
    ...
    <head>
        ...
        <meta name='description' content=067&#32;&#32;性能设计篇之秒杀>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="067  性能设计篇之秒杀" class="title">067  性能设计篇之秒杀</h1>
                            <div><p>一说起秒杀，大家都觉得这事很有技术含量。实际上，并不是这个样子的，秒杀这种互联网的交易方式其实并没有我们想像中的那么复杂。下面先让我们来简单地看一下，秒杀是怎么做的。</p>

<h1 id="秒杀的流程">秒杀的流程</h1>

<p>&rdquo; 秒杀 &ldquo; 其实是商家为了促销，使用非常低的价格销售商品，比如，1 元卖 iPhone，100 台，于是来了一百万人抢购。</p>
...
<p>接下来，我们需要来看一下 &rdquo; 秒杀 &ldquo; 的技术挑战。</p>
...
<p>这就是整个 &rdquo; 秒杀 &ldquo; 的技术细节，是不是有点不敢相信？</p>
