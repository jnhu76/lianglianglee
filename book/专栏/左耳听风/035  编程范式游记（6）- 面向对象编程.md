...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="035  编程范式游记（6）- 面向对象编程" class="title">035  编程范式游记（6）- 面向对象编程</h1>
...
<ul>
<li>&ldquo;Program to an ‘interface’, not an ‘implementation’.&rdquo;
...
<li>&ldquo;Favor ‘object composition’ over ‘class inheritance’.&rdquo;
