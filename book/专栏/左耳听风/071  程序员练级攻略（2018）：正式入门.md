...
<head>
    ...
    <head>
        ...
        <meta name='description' content=071&#32;&#32;程序员练级攻略（2018）：正式入门>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="071  程序员练级攻略（2018）：正式入门" class="title">071  程序员练级攻略（2018）：正式入门</h1>
...
<p>在系统地学习编程技能之前，我希望你能先看一下 &ldquo; <a href="http://blog.thefirehoseproject.com/posts/learn-to-code-and-be-self-reliant/" target="_blank">The Key To Accelerating Your Coding Skills</a>&ldquo;， 这篇文章会告诉你如何有效地快速提高自己的编程能力。</p>
...
<p>而且，你已经是一个 &rdquo; 全栈工程师 &ldquo; 的样子了，在这里我要给你一个大大的赞。如果这个时候，你对编程还有很大的热情，那么我要恭喜你了，你可能会是一个非常不错的程序员。加油啊！</p>
