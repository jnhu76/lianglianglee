...
<head>
    ...
    <head>
        ...
        <meta name='description' content=030&#32;&#32;编程范式游记（3）&#32;-&#32;类型系统和泛型的本质>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="030  编程范式游记（3） - 类型系统和泛型的本质" class="title">030  编程范式游记（3） - 类型系统和泛型的本质</h1>
...
<ul>
<li>有的像 Visual Basic 语言会给出的结果是 42：系统将字符串 &ldquo;37&rdquo; 转换成数字 37，以匹配运算上的直觉。</li>
<li>而有的像 JavaScript 将会产生的结果是 &ldquo;537&rdquo;：系统将数字 5 转换成字符串 &ldquo;5&rdquo; 并把两者串接起来。</li>
</ul>
