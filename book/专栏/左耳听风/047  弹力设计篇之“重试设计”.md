...
<head>
    ...
    <head>
        ...
        <meta name='description' content=047&#32;&#32;弹力设计篇之“重试设计”>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="047  弹力设计篇之“重试设计”" class="title">047  弹力设计篇之“重试设计”</h1>
...
<p>所以，我们需要一个重试的机制。但是，我们需要明白的是，<strong>&rdquo; 重试 &ldquo; 的语义是我们认为这个故障是暂时的，而不是永久的，所以，我们会去重试</strong>。</p>
...
<p>在重试的设计中，我们一般都会引入，Exponential Backoff 的策略，也就是所谓的 &rdquo; 指数级退避 &ldquo;。在这种情况下，每一次重试所需要的休息时间都会翻倍增加。这种机制主要是用来让被调用方能够有更多的时间来从容处理我们的请求。这其实和 TCP 的拥塞控制有点像。</p>
