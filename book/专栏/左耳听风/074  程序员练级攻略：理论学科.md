...
<head>
    ...
    <head>
        ...
        <meta name='description' content=074&#32;&#32;程序员练级攻略：理论学科>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="074  程序员练级攻略：理论学科" class="title">074  程序员练级攻略：理论学科</h1>
...
<li>《<a href="https://book.douban.com/subject/3296317/" target="_blank">编译原理</a>》，这本书又叫 &ldquo; 龙书 &ldquo;，其全面、深入地探讨了编译器设计方面的重要主题，包括词法分析、语法分析、语法制导定义和语法制导翻译、运行时刻环境、目标代码生成、代码优化技术、并行性检测以及过程间分析技术，并在相关章节中给出大量的实例。与上一版相比，本书进行了全面的修订，涵盖了编译器开发方面的最新进展。每章中都提供了大量的系统及参考文献。</li>
</ul>
