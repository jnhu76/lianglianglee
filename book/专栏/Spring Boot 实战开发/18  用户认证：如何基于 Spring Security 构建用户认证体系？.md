...
<head>
    ...
    <head>
        ...
        <meta name='description' content=18&#32;&#32;用户认证：如何基于&#32;Spring&#32;Security&#32;构建用户认证体系？>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="18  用户认证：如何基于 Spring Security 构建用户认证体系？" class="title">18  用户认证：如何基于 Spring Security 构建用户认证体系？</h1>
...
<p>从上面的代码中，我们看到系统中存在&rdquo;springcss _user&rdquo;和&rdquo;springcss _admin&rdquo;这两个用户，其密码分别是&rdquo;password1&rdquo;和&rdquo;password2&rdquo;，分别代表着普通用户 USER 及管理员 ADMIN 这两个角色。</p>
...
<p>从上述代码中，我们看到 withUser 方法返回的是一个 UserDetailsBuilder 对象，通过该对象可以实现类似 .withUser(&ldquo;springcss_user&rdquo;).password(&ldquo;password1&rdquo;).roles(&ldquo;USER&rdquo;) 这样的链式语法，从而完成用户信息的设置。</p>
