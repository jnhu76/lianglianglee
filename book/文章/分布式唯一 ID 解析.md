...
<head>
    ...
    <head>
        ...
        <meta name='description' content=分布式唯一&#32;ID&#32;解析>
        <link rel="icon" href="/static/favicon.png">
        <title>分布式唯一 ID 解析 </title>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="分布式唯一 ID 解析" class="title">分布式唯一 ID 解析</h1>
                            <div><h1 id="业界常见解决方案">业界常见解决方案</h1>

<h2 id="uuid">UUID</h2>

<p><a href="https://en.wikipedia.org/wiki/Universally_unique_identifier#:~:text=A universally unique identifier (UUID,are for practical purposes unique.)" target="_blank">uuid</a></p>
...
<h2 id="redis-生成-id">Redis 生成 Id</h2>
...
<h2 id="美团-leaf">美团 Leaf</h2>

<p>原文：<a href="https://tech.meituan.com/2017/04/21/mt-leaf.html" target="_blank">https://tech.meituan.com/2017/04/21/mt-leaf.html</a></p>

<h3 id="leaf-segment">Leaf Segment</h3>
...
<h3 id="leaf-snowflake">Leaf Snowflake</h3>
...
<h2 id="微信序列号生成器">微信序列号生成器</h2>

<p>原文：<a href="https://mp.weixin.qq.com/s/JqIJupVKUNuQYIDDxRtfqA" target="_blank">https://mp.weixin.qq.com/s/JqIJupVKUNuQYIDDxRtfqA</a></p>
...
<p>原文：<a href="https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md" target="_blank">https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md</a></p>
...
<h2 id="mongodb-objectid-https-docs-mongodb-com-v3-2-reference-method-objectid"><a href="https://docs.mongodb.com/v3.2/reference/method/ObjectId/" target="_blank">MongoDB ObjectID</a></h2>

<p>原文：<a href="https://docs.mongodb.com/v3.2/reference/method/ObjectId/" target="_blank">https://docs.mongodb.com/v3.2/reference/method/ObjectId/</a></p>
...
<h1 id="解决分布式唯一-id-的一个想法">解决分布式唯一 ID 的一个想法</h1>
...
<p>duration_step 可以设置为两天（或更长），每隔一天异步到 DB 申请一个时间号段（即设置 DB last_timestamp += duration_step）；可以做到弱依赖 DB</p>

<h1 id="参考">参考</h1>

<p><a href="https://en.wikipedia.org/wiki/Universally_unique_identifier#:~:text=A universally unique identifier (UUID,are for practical purposes unique.)" target="_blank">Universally unique identifier</a></p>

<p><a href="https://developer.twitter.com/en/docs/basics/twitter-ids" target="_blank">Twitter IDs (snowflake)</a></p>

<p><a href="https://tech.meituan.com/2017/04/21/mt-leaf.html" target="_blank">Leaf——美团点评分布式ID生成系统</a></p>

<p><a href="https://mp.weixin.qq.com/s/JqIJupVKUNuQYIDDxRtfqA" target="_blank">万亿级调用系统：微信序列号生成器架构设计及演变</a></p>

<p><a href="https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md" target="_blank">百度UidGenerator</a></p>

<p><a href="https://docs.mongodb.com/v3.2/reference/method/ObjectId/" target="_blank">MongoDB ObjectID</a></p>
</div>
                        </div>
                        <div>
