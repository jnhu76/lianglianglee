...
<blockquote>
<p><a href="https://geode.apache.org/docs/guide/19/rest_apps/develop_rest_apps.html" target="_blank">https://geode.apache.org/docs/guide/19/rest*apps/develop*rest_apps.html</a></p>
</blockquote>

<h3 id="geode-部署模式">Geode 部署模式</h3>
...
<h3 id="geode-滚动升级">Geode 滚动升级</h3>
...
<h4 id="重启-locator">重启 locator</h4>

<h5 id="停止旧的主-locator"><strong>停止旧的主 locator</strong></h5>
...
<h5 id="修改-etc-profile-更改环境变量"><strong>修改 /etc/profile 更改环境变量</strong></h5>
...
<h5 id="启动新-locator"><strong>启动新 locator</strong></h5>
...
<h4 id="重启-server">重启 server</h4>

<h5 id="重启旧版本的-server"><strong>重启旧版本的 server</strong></h5>
...
<h3 id="geode-图形化与监控">Geode 图形化与监控</h3>
...
<h4 id="gfsh-脚本进行监控">gfsh 脚本进行监控</h4>

<p>这种监控一些数量大小之类的还可以，目前还没发现对读、写等详细的指标命令。</p>

<h4 id="jmx-获取数据进行监控">JMX 获取数据进行监控</h4>
...
<h3 id="geode-常见故障与恢复">Geode 常见故障与恢复</h3>

<h4 id="从机器崩溃中恢复">从机器崩溃中恢复</h4>
...
<h4 id="防止和恢复磁盘完全错误">防止和恢复磁盘完全错误</h4>
...
<h4 id="java-lang-outofmemoryerror">java.lang.OutOfMemoryError</h4>
...
<h4 id="成员太长时间没有回应">成员太长时间没有回应</h4>
...
<p><strong>如上只是摘抄了几个官方常见异常</strong>，<a href="https://geode.apache.org/docs/guide/19/managing/troubleshooting/chapter_overview.html" target="_blank">具体请查看这里</a>。</p>

<p>实际在近一年多的使用中，并未发现不可思议的异常与灾难。</p>

<h3 id="目前我司使用情况">目前我司使用情况</h3>
...
<blockquote>
<p><a href="https://gitee.com/gavinage/geode_study" target="_blank">https://gitee.com/gavinage/geode_study</a></p>
</blockquote>

<h4 id="geode-扩展功能">Geode 扩展功能</h4>
...
<p>Geode 使用了不小的篇幅来描述该扩展功能，<a href="https://geode.apache.org/docs/guide/110/tools_modules/http_session_mgmt/quick_start.html" target="_blank">详见</a>。</p>
