...
<head>
    ...
    <head>
        ...
        <meta name='description' content=认识&#32;MySQL&#32;和&#32;Redis&#32;的数据一致性问题>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="认识 MySQL 和 Redis 的数据一致性问题" class="title">认识 MySQL 和 Redis 的数据一致性问题</h1>
...
<p><img src="assets/v2-743a97e88d1d0bf906b7e1e3bec7a99d_b.jpg" alt="img" /></p>

<ul>
<li><strong>更新（修改/删除）数据时</strong> ，会有个时序问题：更新数据库与删除缓存的顺序（这个过程会发生数据不一致性问题）</li>
</ul>

<p><img src="assets/v2-34d9206cb3158ab96e5c5462de05e817_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-6a6d482d7f275d3dde89e134af9e7858_b.jpg" alt="img" /></p>

<p><strong>(2) 先更新数据库，再删除缓存</strong></p>

<p><img src="assets/v2-6f951d6291001bf7e9bbc6f2e856a1db_b.jpg" alt="img" /></p>

<p><img src="assets/v2-f4e7a92c44a67694ad91ca0eb1f189aa_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-6d6dd4dc404567c1402eaba8a12f8f48_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-638ab1dea36af1b57a7ccf2f5a09aa2b_b.jpg" alt="img" /></p>

<p>或者</p>

<p><img src="assets/v2-797a59a095fa8e4d7b0e61d95b928c6a_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-5ce3b6ddcae7a203a983fb74124e6f2e_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-17531f4ab67f9f3cd8450854e740bf46_b.jpg" alt="img" /></p>

<p>或者，在”先更新数据库，再删除缓存”方案下，“读写分离 + 主从库延迟”也会导致不一致：</p>

<p><img src="assets/v2-862b9e280ded89432847506d1d70f65a_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-b14eed88789caca84a7cb25eaad54fb0_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-a7d9ce347ea85a557ee9cd21d873a736_b.jpg" alt="img" /></p>

<h3 id="b-高并发情况-1"><strong>B. 高并发情况</strong></h3>

<p>有四种场景会造成数据不一致：</p>

<p><img src="assets/v2-d4a568661a04f769e17238ff44513eb0_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-b41f38d2c55bbfba734d3463c2d6ce46_b.jpg" alt="img" /></p>

<p>其中，分布式锁的实现可以使用以下策略：</p>

<p><img src="assets/v2-ea428da2331b4f04f65fb720ac80a829_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-34125bb8924b7c221739ceaae8f936e2_b.jpg" alt="img" /></p>

<p>针对读写缓存时：同步直写，更新数据库+更新缓存</p>

<p><img src="assets/v2-0794689daefbbab6f3b9230075d68954_b.jpg" alt="img" /></p>

<p>针对只读缓存时：更新数据库+删除缓存</p>

<p><img src="assets/v2-c71d826fb485bfa2312d4588df60d751_b.jpg" alt="img" /></p>
...
<p><img src="assets/v2-70b01bc5d80e67981e8904e95860ae00_b.jpg" alt="img" /></p>
