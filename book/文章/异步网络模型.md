...
<head>
    ...
    <head>
        ...
        <meta name='description' content=异步网络模型>
...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="异步网络模型" class="title">异步网络模型</h1>
                            <div><p>异步网络模型在服务开发中应用非常广泛，相关资料和开源库也非常多。项目中，使用现成的轮子提高了开发效率，除了能使用轮子，还是有必要了解一下轮子的内部构造。</p>
...
<h3 id="reactor事件处理模型"><strong>Reactor事件处理模型</strong></h3>
...
<h3 id="proactor事件处理模型">Proactor事件处理模型</h3>
...
<h3 id="同步i-o模拟proactor">同步I/O模拟Proactor</h3>
...
<h4 id="半同步-半异步工作流程"><strong>半同步/半异步工作流程</strong></h4>
...
<h4 id="半同步-半反应堆模式">半同步/半反应堆模式</h4>
...
<h3 id="follower-leader-模式">Follower/Leader 模式</h3>
...
<h2 id="swoole-网络模型分析">Swoole 网络模型分析</h2>
...
<h4 id="master-process"><strong>Master Process</strong></h4>
...
<h4 id="work-process">Work Process</h4>
...
<h4 id="进程间通信"><strong>进程间通信</strong></h4>
...
<ol>
<li>启用一个定时器，运行间隔1s，更新current_index，指向环形队列下一个元素，0-&gt;1-&gt;2-&gt;3&hellip;-&gt;58-&gt;59-&gt;60&hellip;0；</li>
...
<script data-cfasync="false" src="/static/email-decode.min.js"></script><script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8f0c78b6cd01ede4',t:'MTczMzk5MzQ3NS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/static/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
