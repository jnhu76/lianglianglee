...
<h5 id="3-4-1-来源"><strong>3.4.1 来源</strong></h5>
...
<h3 id="4-从数据复制看一致性">4. 从数据复制看一致性</h3>
...
<h4 id="4-1-主从异步复制">4.1 主从异步复制</h4>
...
<h4 id="4-2-主从同步复制">4.2 主从同步复制</h4>
...
<h4 id="4-3-主从半同步复制">4.3 主从半同步复制</h4>
...
<h4 id="4-4-多数派-quorum-读写">4.4 多数派（quorum）读写</h4>

<h5 id="4-4-1-初识"><strong>4.4.1 初识</strong></h5>
...
<h5 id="4-4-2-版本号"><strong>4.4.2 版本号</strong></h5>
...
<h5 id="4-4-3-并发问题"><strong>4.4.3 并发问题</strong></h5>
...
<h5 id="4-4-4-客户端版本号"><strong>4.4.4 客户端版本号</strong></h5>
...
<h3 id="5-paxos">5. Paxos</h3>

<h4 id="5-1-初识">5.1 初识</h4>

<p>Paxos 是 Lamport（没错又是他） 1998 年在 <em>The Part-Time Parliament</em> 论文中描述的一个算法，最初使用希腊的一个小岛 Paxos 作为比喻（拜占庭将军问题的描述手法），描述了 Paxos 岛中通过决议的流程，并以此命名这个算法，但是这个描述理解起来比较困难，也没有引起很大的反响。2001 年，Lamport 觉得同行不能理解他的幽默感，于是重新发表了朴实的算法描述版 本*Paxos Made Simple*，简单直接的讲解了该算法。</p>

<p>Paxos 解决的是分布式系统下的共识问题：一个集群如何对一个 key 的 value 是什么达成共识，确定出一个唯一值。</p>

<h4 id="5-2-特点和前提">5.2 特点和前提</h4>

<h5 id="5-2-1-特点"><strong>5.2.1 特点</strong></h5>
...
<h5 id="5-2-2-前提"><strong>5.2.2 前提</strong></h5>
...
<h4 id="5-3-算法描述">5.3 算法描述</h4>

<p>Paxos 使用两阶段 RPC 来对一个值达成共识，第一阶段 RPC 主要是用来确定自己是否有权限执行&rdquo;写入&rdquo;操作；第二阶段 RPC 是执行&rdquo;写入&rdquo;操作，和上一部分所讲的多数派读写基本一致。</p>

<p>其中，发请求的节点被称之为 Proposer，而接收请求的节点称之为 Acceptor，当 Acceptor 最终确定了一个值后，会发送给所有的 Learner，最终集群中所有的节点都持有最新被确定的值。</p>

<h5 id="5-3-1-算法成员"><strong>5.3.1 算法成员</strong></h5>
...
<h5 id="5-3-2-算法里的一些概念"><strong>5.3.2 算法里的一些概念</strong></h5>
...
<h5 id="5-3-3-具体算法"><strong>5.3.3 具体算法</strong></h5>
...
<h5 id="5-3-4-完整的-paxos-流程"><strong>5.3.4 完整的 Paxos 流程</strong></h5>
...
<h4 id="5-4-算法推导">5.4 算法推导</h4>

<p>Paxos 算法是一个通过数学方式推导出的算法，有一套完整的推导过程，这里整理翻译自<a href="http://lamport.azurewebsites.net/pubs/paxos-simple.pdf" target="_blank">原文</a>。</p>
...
<h4 id="5-5-paxos-存在的问题">5.5 Paxos 存在的问题</h4>
...
<h4 id="5-6-lease-机制">5.6 Lease 机制</h4>
...
<blockquote>
<p>本小节上述内容翻译自 *Paxos made simple*，有删改。</p>
</blockquote>
...
<h4 id="5-8-multi-paxos">5.8 Multi-Paxos</h4>
...
<h3 id="6-raft">6. Raft</h3>

<h4 id="6-1-初识">6.1 初识</h4>
...
<h4 id="6-2-概念">6.2 概念</h4>

<blockquote>
<p>概念这一小节部分内容翻译自 <a href="https://raft.github.io/raft.pdf" target="_blank">Raft 算法原文</a>，有较多删改和重新排序。</p>
</blockquote>

<h5 id="6-2-1-复制状态机"><strong>6.2.1 复制状态机</strong></h5>
...
<h5 id="6-2-2-节点角色"><strong>6.2.2 节点角色</strong></h5>
...
<h5 id="6-2-3-leader-任期"><strong>6.2.3 Leader 任期</strong></h5>
...
<h5 id="6-2-4-rpc"><strong>6.2.4 RPC</strong></h5>
...
<h4 id="6-3-算法描述">6.3 算法描述</h4>

<h5 id="6-3-1-leader-选举"><strong>6.3.1 Leader 选举</strong></h5>
...
<h5 id="6-3-2-日志复制"><strong>6.3.2 日志复制</strong></h5>
...
<h5 id="6-3-3-appendentries-rpc"><strong>6.3.3 AppendEntries RPC</strong></h5>
...
<h4 id="6-6-成员变更-配置变更">6.6 成员变更（配置变更）</h4>
...
<p>详细内容可以参考：<a href="https://web.stanford.edu/~ouster/cgi-bin/papers/OngaroPhD.pdf" target="_blank">CONSENSUS: BRIDGING THEORY AND PRACTICE</a>，这篇是斯坦福教授基于 Raft 的论文，该论文讲 Raft 协议细化，提出了更多搞可用的设计方案。etcd-raft 就是基于这篇论文实现的。</p>
...
<h4 id="8-1-基本理论">8.1 基本理论</h4>

<ul>
<li><a href="https://zh.m.wikipedia.org/wiki/CAP" target="_blank">CAP 定理 - wiki</a></li>
<li><a href="http://www.hollischuang.com/archives/666" target="_blank">分布式系统的 CAP 理论</a></li>
<li><a href="https://blog.the-pans.com/cap/" target="_blank">请不要再称数据库是 CP 或者 AP</a></li>
<li><a href="https://zh.wikipedia.org/wiki/拜占庭将军问题" target="_blank">拜占庭将军问题 - 维基百科</a></li>
<li><a href="http://lamport.azurewebsites.net/pubs/byz.pdf" target="_blank">拜占庭将军问题 - lamport 论文</a></li>
<li><a href="https://zh.wikipedia.org/wiki/對等網路" target="_blank">对等网络（点对点网络） - 维基百科</a></li>
<li><a href="https://juejin.im/post/5b2663fcf265da59a401e6f8" target="_blank">BASE理论</a></li>
<li><a href="https://zhuanlan.zhihu.com/p/48782892" target="_blank">分布式系统中的一致性模型</a></li>
<li><a href="https://wudaijun.com/2018/09/distributed-consistency/" target="_blank">一致性杂谈</a></li>
<li><a href="https://www.infoq.cn/article/cache-coherency-primer/" target="_blank">缓存一致性（Cache Coherency）入门</a></li>
<li><a href="https://pingcap.com/blog-cn/linearizability-and-raft/" target="_blank">线性一致性和 Raft</a></li>
</ul>

<h4 id="8-2-paxos-相关">8.2 Paxos 相关</h4>

<ul>
<li><a href="https://github.com/Tencent/phxpaxos" target="_blank">微信 Paxos 实现</a></li>
<li><a href="https://zh.wikipedia.org/wiki/Paxos算法" target="_blank">维基百科 Paxos</a></li>
<li><a href="https://zhuanlan.zhihu.com/p/31727291" target="_blank">Paxos、Raft 分布式一致性算法应用场景</a></li>
<li><a href="https://zhuanlan.zhihu.com/p/31780743" target="_blank">Paxos 算法详解</a></li>
