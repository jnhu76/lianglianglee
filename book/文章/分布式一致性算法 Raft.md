...
<body>
    ...
    overflow-y: hidden;">
                        <div class="book-post">
                            ...
                            <h1 id="title" data-id="分布式一致性算法 Raft" class="title">分布式一致性算法 Raft</h1>
                            <div><h3 id="一-raft-算法背景"><strong>一、Raft 算法背景</strong></h3>
...
<h3 id="二-raft-算法基本原理"><strong>二、Raft 算法基本原理</strong></h3>
...
<h3 id="2-1-leader-election-领导选举"><strong>2.1 Leader Election 领导选举</strong></h3>
...
<ul>
<li><p>当 Candidate 获得超过半数的投票时，代表自己赢得了选举，且转化为 leader。此时，它会马上向其他节点发送请求，从而确认自己的 leader 地位，从而阻止新一轮的选举；</p></li>

<li><p><strong>投票原则</strong>：当多个 Candidate 竞选 Leader 时：</p></li>
...
<h3 id="2-2-log-replication-日志复制"><strong>2.2 Log Replication 日志复制</strong></h3>
...
<h3 id="2-3-safety-安全性"><strong>2.3 Safety 安全性</strong></h3>
...
<h3 id="2-3-1-election-safety-选举安全性-避免脑裂问题"><strong>2.3.1 Election Safety 选举安全性：避免脑裂问题</strong></h3>
...
<h3 id="2-3-2-leader-append-only-日志只能由-leader-添加修改"><strong>2.3.2 Leader Append-Only 日志只能由 leader 添加修改</strong></h3>
...
<h3 id="2-3-3-log-matching-日志匹配特性"><strong>2.3.3 Log Matching 日志匹配特性</strong></h3>
...
<h3 id="2-3-4-leader-completeness-选举完备性-leader-必须具备最新提交日志"><strong>2.3.4 Leader Completeness 选举完备性：leader 必须具备最新提交日志</strong></h3>
...
<h3 id="2-3-5-state-machine-safety-状态机安全性-确保当前任期日志提交"><strong>2.3.5 State Machine Safety 状态机安全性：确保当前任期日志提交</strong></h3>
...
<h3 id="三-paxos-vs-raft-这个世界上只有一种一致性算法-那就是-paxos"><strong>三、Paxos VS Raft：这个世界上只有一种一致性算法，那就是 Paxos</strong></h3>
